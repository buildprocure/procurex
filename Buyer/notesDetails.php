...
<body>
    ...
    <div class ="main-content">
        ...
        <form method="post" action="">
            ...
            <label for="comments">Comments added from supplier:</label><br>
            <textarea id="comments" name="comments" rows="4" cols="50" placeholder = "Comments will be added by supplier" readonly><?php echo htmlspecialchars($result['Comments']); ?></textarea><br><br>
        </form>
    </div>
