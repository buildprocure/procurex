...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($status)) {
        ...
        if (($status == "Rejected") && empty($comments)) {
            ...
            SELECT CONCAT('PyID-', LEFT(UUID(), 10)), i.id, b.buyer_id, i.amount, Null, s.supplier_id, 'Bank Transfer', 'Pending', DATE_ADD(NOW(), INTERVAL 7 DAY), NOW()
            FROM Invoice i
                ...
                <div class="col-md-6">
                    <?php if ($POupdate): ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <strong>Success!</strong> Invoice has been approved and notified to supplier successfully.
                    ...
                    <div class="card shadow mb-4">
                            ...
                            <table class="table table-bordered">
                                <tr><th>Invoice ID:</th><td><?php echo htmlspecialchars($result['ID']); ?></td></tr>
